...
class RequiredMonthlyChecksPage extends StatefulWidget {
  final String EMPID;
  final String Group;
  RequiredMonthlyChecksPage({required this.EMPID, required this.Group});
  @override
  State<RequiredMonthlyChecksPage> createState() =>
      _RequiredMonthlyChecksPage();
}

class _RequiredMonthlyChecksPage extends State<RequiredMonthlyChecksPage> {
